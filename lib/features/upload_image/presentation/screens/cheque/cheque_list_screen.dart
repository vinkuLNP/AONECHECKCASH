...
import 'package:a1_check_cashers/features/upload_image/presentation/widgets/cheque_filter_dropdown.dart';
import 'package:a1_check_cashers/features/upload_image/presentation/widgets/empty_cheque_view.dart';
...
class ChequeListScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final cheques = context.watch<UploadProvider>().cheques;

    return Scaffold(
      appBar: AppBar(
        title: AppText(text: AppStrings.cheques, color: AppColors.black),
        actions: const [ChequeFilterDropdown()],
      ),
